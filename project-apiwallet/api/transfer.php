...
//    }
    ...
    if($api_req == "POST"){
        ...
        $i_user_idcard   = $_POST["i_user_idcard"];     //input idcard or phone(promtpay or wallet)
        $f_user_balance   = $_POST["f_user_balance"];
        $i_atype_accouttype_id   = $_POST["i_atype_accouttype_id"]; //status 1=Banks, 2=promtpay, 3=wallet
        if($db->transfer($c_user_phone, $i_user_idcard, $f_user_balance, $i_atype_accouttype_id)){
